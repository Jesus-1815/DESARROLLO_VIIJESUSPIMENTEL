...
function busquedaAvanzada($pdo, array $criterios) {
    ...
    // Añadir HAVING si es necesario
    if (isset($criterios['having'])) {
        foreach ($criterios['having'] as $condition) {
            $qb->having($condition['field'], $condition['value']);
        }
    }
...
$criterios = [
    ...
    'limite' => 10,
    'having' => [
        ['field' => 'COUNT(*)', 'value' => 2] // Esto será "HAVING COUNT(*) > 2"
    ]
];
