...
$miArray = ["Pyro","Dendro","Geo"]; // Reemplaza esto con tu propio array
$miString = "Jesus"; // Reemplaza esto con tu propio string
$miNumero = 345; // Reemplaza esto con tu propio número
