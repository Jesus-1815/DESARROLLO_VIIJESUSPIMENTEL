...
echo "Array de frutas después de array_push():";
print_r($frutas);

// Ejercicio: Crea un array con los nombres de 3 de tus amigos
// y usa array_push() para añadir 2 amigos más
$misAmigos = ["Kevin","Chun","Enrrique"]; // Reemplaza esto con tu array de amigos
array_push($misAmigos, "Federico", "Franklin"); // Reemplaza las comillas vacías con los nombres de tus amigos
print_r($misAmigos);
